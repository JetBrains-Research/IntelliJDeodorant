...
public class SystemObject {
    ...
    private Map<gr.uom.java.ast.MethodInvocationObject, gr.uom.java.ast.FieldInstructionObject> getterMap;
    private Map<gr.uom.java.ast.MethodInvocationObject, gr.uom.java.ast.FieldInstructionObject> setterMap;
    private Map<gr.uom.java.ast.MethodInvocationObject, gr.uom.java.ast.FieldInstructionObject> collectionAdderMap;
    private Map<gr.uom.java.ast.MethodInvocationObject, gr.uom.java.ast.MethodInvocationObject> delegateMap;

    public SystemObject() {
        this.classList = new ArrayList<gr.uom.java.ast.ClassObject>();
        this.classNameMap = new HashMap<String, Integer>();
        this.getterMap = new LinkedHashMap<gr.uom.java.ast.MethodInvocationObject, gr.uom.java.ast.FieldInstructionObject>();
        this.setterMap = new LinkedHashMap<gr.uom.java.ast.MethodInvocationObject, gr.uom.java.ast.FieldInstructionObject>();
        this.collectionAdderMap = new LinkedHashMap<gr.uom.java.ast.MethodInvocationObject, gr.uom.java.ast.FieldInstructionObject>();
        this.delegateMap = new LinkedHashMap<gr.uom.java.ast.MethodInvocationObject, gr.uom.java.ast.MethodInvocationObject>();
    }

    public void addClass(gr.uom.java.ast.ClassObject c) {
        classNameMap.put(c.getName(),classList.size());
        classList.add(c);
    }
    
    public void addClasses(List<gr.uom.java.ast.ClassObject> classObjects) {
    ...
    public void removeClasses(PsiFile file) {
    ...
    public void addGetter(gr.uom.java.ast.MethodInvocationObject methodInvocation, FieldInstructionObject fieldInstruction) {
...
/*    public AbstractMethodDeclaration getMethodObject(PsiMethod method) {
    	try {
